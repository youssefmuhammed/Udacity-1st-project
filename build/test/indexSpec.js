...
describe('endpoint: /api/img', () => {
    ...
    it('gets /api/img/?filename=portfolio2&width=400&height=400', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request.get('/api/img?filename=portfolio1&width=200&height=200');
        expect(response.status).toBe(200);
    }));
    it('gets /api/img/?filename=portfolio3&width=600&height=600', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request.get('/api/img?filename=portfolio1&width=200&height=200');
        expect(response.status).toBe(200);
    }));
});
